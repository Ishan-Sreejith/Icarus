...
.str0:
    ...
    .quad -1
    .quad 33
    .asciz "→ Starting Metroman Import Test"
    .align 3
.str1:
    .quad 3
    .quad -1
...
.str2:
    ...
    .quad -1
    .quad 46
    .asciz "✓ Plugin function call returned successfully"
    .align 3
.str3:
    .quad 3
    .quad -1
    .quad 42
    .asciz "→ Math result from plugin (5 * 4 + 10): "
    .align 3
.str4:
    .quad 3
    .quad -1
    .quad 27
    .asciz "✓ Plugin math test passed"
    .align 3
.str5:
    .quad 3
    .quad -1
...
.str7:
    ...
    .quad -1
    .quad 34
    .asciz "→ Metroman Test Project Finished"
    .align 3
.str8:
    .quad 3
    .quad -1
